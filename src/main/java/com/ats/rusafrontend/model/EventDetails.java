...
public class EventDetails {
	...
	public String toString() {
		return "EventDetails [regId=" + regId + ", userUuid=" + userUuid + ", userType=" + userType + ", emails="
				...
				+ ", smsVerified=" + smsVerified + ", editByAdminuserId=" + editByAdminuserId + ", userId=" + userId
				+ ", regDate=" + regDate + ", eventRegId=" + eventRegId + "]";
	}
