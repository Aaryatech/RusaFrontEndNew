...
public class EventReg {
	...
	public String toString() {
		return "EventReg [newsblogsId=" + newsblogsId + ", pageId=" + pageId + ", newsSourceUrlName="
				...
				+ featuredImage + ", downloadPdf=" + downloadPdf + ", isActive=" + isActive + ", delStatus=" + delStatus
				+ ", exInt1=" + exInt1 + ", exInt2=" + exInt2 + ", heading=" + heading + ", descriptions="
				+ descriptions + ", pageMetaTitle=" + pageMetaTitle + ", pageMetaDescription=" + pageMetaDescription
				+ ", pageMetaKeyword=" + pageMetaKeyword + ", languageId=" + languageId + ", userId=" + userId
				+ ", regDate=" + regDate + ", statusApproval=" + statusApproval + ", approvalDate=" + approvalDate
				+ ", approveBy=" + approveBy + ", doc1=" + doc1 + ", doc2=" + doc2 + ", name=" + name + "]";
	}
