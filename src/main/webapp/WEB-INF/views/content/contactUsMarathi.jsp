			...
			<div class="col-12 col-sm-12 col-lg-12 right-Colm">
				...
				<div class="row row-eq-height">
					...
					<div class="col-12 col-sm-12 col-lg-6">
						...
						<p>
							राज्य प्रकल्प संचालनालय (एसपीडी), राष्ट्रीय उच्चतर शिक्षा अभियान
							(रुसा), महाराष्ट्र, १८ वा मजला, केंद्र १, वर्ल्ड ट्रेड सेंटर , कफ
							परेड, कुलाबा, मुंबई - ४००००५.<br> ई - मेल:
							spdrusamah@gmail.com<br>दूरध्वनी क्रमांक : ०२२-२२१६०९५९
						</p>
						<!-- <iframe class="map"
					...
					<div class="col-12 col-sm-12 col-lg-6">
						...
						<form action="${pageContext.request.contextPath}/insertContactUs"
							...
							<input type="hidden" value="<%out.println(hashtext);%>"
												name="token" id="token">
							<p>
								<strong>कृपया तुमचा संदेश पाठवा</strong>
							</p>
							<div class="row">
								<div class="col-12 col-sm-4 col-lg-4">
									<input type="radio" name="formType" value="Query" checked
										id="radio1"> <label for="radio1"></label> <span>प्रश्न</span>
								</div>


								<div class="col-12 col-sm-4 col-lg-4">
									<input type="radio" name="formType" value="Feedback"
										id="radio2"> <label for="radio2"></label> <span>अभिप्राय</span>
								</div>
							...
							<br> <label>आपले नाव</label> <input type="text"
								class="form-control" name="name" id="name" placeholder="नाव"
								autocomplete="off" onchange="trim(this)">
							<p class="error-msg" id="error_name" style="display: none;">कृपया
								आपले नांव लिहा</p>

							<label>आपला ई - मेल</label> <input type="text"
								class="form-control" name="email" id="email"
								placeholder="ई - मेल" autocomplete="off" onchange="trim(this)">
							<p class="error-msg" id="error_email" style="display: none;">कृपया
								वैध ईमेल लिहा</p>
							<label>फोन नंबर</label> <input type="text" class="form-control"
								name="mobileNo" id="mobileNo" maxlength=10
								placeholder="फोन नंबर" autocomplete="off" onchange="trim(this)">
							<p class="error-msg" id="error_mobile" style="display: none;">कृपया
								वैध मोबाइल क्रमांक लिहा</p>
							<label>आपले संदेश</label>
							<textarea name="message" id="message" class="form-control"
								placeholder="संदेश" onchange="trim(this)"></textarea>
							<p class="error-msg" id="error_msg" style="display: none;">आवश्यक
								फील्ड</p>
							...
							<br> <input type="text" class="form-control capcha-input"
								name="captcha" id="captcha" placeholder="मजकूर लिहा"
								autocomplete="off" onchange="trim(this)">
							...
							<!-- <span class="msg-error error" id="error_capmsg"
								...
								Text ! </span> -->
							<p class="error-msg" id="error_capmsg" style="display: none;">अवैध
								मजकूर!</p>
							<br>
