        	...
        	<!-- <div class="col-12 col-sm-3 col-lg-3">
				<div class="leftColm">
                    ...
                    <ul class="menu">
 					...
 					<c:forEach items="${previous}" var="eventList"	varStatus="count">
                    ...
                    <a href="${pageContext.request.contextPath}/eventDetailfront/${eventList.newsblogsId}/1" target="_blank">Read More</a>
                    </div>
                    </div>
                   </c:forEach>
