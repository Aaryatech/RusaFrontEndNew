 ...
 <div class="container" id="main-content">
        <div class="row row-eq-height">
            ...
            <div class="col-12 col-sm-9 col-lg-9 right-Colm news-listing-page">
            	<h2>My Profile <a href="${pageContext.request.contextPath}/editProfile" class="edit-profile">Edit Profile</a></h2>
				...
				<form
					...
					<div class="col-12 col-sm-12 col-lg-6">
								...
								<input
									type="text" class="form-control" name="name" placeholder="Name" value="${editReg.name}"
									id="fullname"> 
							</div>		
