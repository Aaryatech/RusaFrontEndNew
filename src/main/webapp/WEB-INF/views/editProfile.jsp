			...
			<div class="login-box register-box">
				...
				<form
					...
					<div class="row row-eq-height">
						...
						<input type="hidden" name="regId" value="${editReg.regId}">
						<c:choose>
						<c:when test="${isEdit==1}">
							...
							<div class="form-group" style="display: visible" id="individual">
								...
								<label>Email-ID <span class="text-danger">*</span></label> <input
									...
									placeholder="Email" id="email" value="${editReg.emails}"> <label>Alternate
									Email-ID</label> <input type="email" class="form-control"
									name="altEmail" placeholder="Alternate Email" value="${editReg.alternateEmail}" id="altEmail">


								<label>Full Name <span class="text-danger">*</span></label> <input
									type="text" class="form-control" name="name" value="${editReg.name}" placeholder="Name"
									id="fullname"> <label>Mobile No.<span
									class="text-danger">*</span></label> <input type="text"
									class="form-control" name="mobile" value="${editReg.mobileNumber}" pattern="[7-9]{1}[0-9]{9}"
								...
								</label> <input type="text" class="form-control" name="dob" value="${editReg.dob}"
