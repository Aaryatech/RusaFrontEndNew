...
<body>
   ...
   <div class="inner-slider" id="slider">
	...
	<div class="bridcrumb">
    	<div class="container">
        	<a href="${pageContext.request.contextPath}/">Home</a> > <a href="${pageContext.request.contextPath}/"></a> >
        </div>
    </div> 
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-lg-12">
                      ...
                      <c:choose>
                        ...
                        <img src="${sessionScope.gallryImageURL}${testImonial.imageName}" alt="${testImonial.fromName}" title="${testImonial.fromName}" class="img-responsive thumbnail">	
                        </c:when>
                       <c:otherwise>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-lg-12">
                     ...
                     --%>
                       ...
                       <p><span style="margin-left:200px"></span>${testImonial.message}</p>
						<p> 
                        <strong>${testImonial.fromName}</strong>
                      <!--   <span class="sup-text">adsfgthukik</span> -->
                        </p>
